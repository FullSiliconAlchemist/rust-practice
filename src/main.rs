...
use lesson_10::Lesson10;
use lesson_11::Lesson11;
use lesson_12::Lesson12;
...
fn main() {
    ...
    let _t10 = Lesson10 { name: String::from("ENUMS") };
    let _t11 = Lesson11 { name: String::from("ERROR HANDLING") };
    let _t12 = Lesson12 { name: String::from("COLLECTIONS") };
